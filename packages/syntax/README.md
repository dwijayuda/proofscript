...
Source-facing syntax data only. The complete dynamic ProofScript grammar is not implemented yet.


## Production Role

Defines parsed ProofScript source syntax shapes.

## Trust Boundary

Tier: language  
Lifecycle: canonical  
Trust boundary: Surface AST types only; no kernel trust authority.
