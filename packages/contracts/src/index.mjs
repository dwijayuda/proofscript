...
export function statefulPredicateElaborationForContract(contract, stateModel = contract.stateModel, postconditionIR = statefulPostconditionIRForContract(contract, stateModel)) {
  ...
  return {
    ...
    sourceIRSchema: postconditionIR?.schema ?? null,
