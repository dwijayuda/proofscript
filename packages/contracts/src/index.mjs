  ...
  return {
    artifact: {
      ...
      trustBoundary: {
        semanticProofChecking: false,
        hiddenAxioms: false,
        monadicContracts: 'state-model-descriptor-bound',
        verificationProfile: verification.profile,
        specifiedStructuralProfile: verification.profile === MONADIC_VERIFICATION_PROFILE,
        stateModelDescriptorValidated: true,
        statefulReferenceTypingComplete: statefulPredicateElaboration.referenceTypingComplete,
        normalizedPredicateAstTypeCheckingComplete: statefulPredicateAST.typeCheckingComplete,
        stateOperationTypingComplete: statefulOperationElaboration.typingComplete,
