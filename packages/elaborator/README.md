...
K0 source-to-core elaboration. General unification, metavariables, implicit insertion, typeclasses, pattern compilation and recursion elaboration remain future milestones.


## Production Role

Elaborates syntax into checked Core candidates, with proof/match/inductive submodules.

## Trust Boundary

Tier: language  
Lifecycle: canonical  
Trust boundary: Produces explicit Core; kernel still validates trusted terms.
