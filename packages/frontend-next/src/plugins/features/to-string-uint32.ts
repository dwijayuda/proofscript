...
export const proofscriptManifest: PluginManifest = {
  ...
  id: "proofscript.feature.to-string-uint32",
  version: "0.91.0",
  kind: "feature",
  semanticIds: ["lean.instance.ToString.UInt32"],
...
const plugin: ProofScriptPlugin = {
  ...
  kind: "feature",
  requires: ["proofscript.feature.to-string", "proofscript.feature.uint32"],
  setup(registry) {
    registry.registerBuiltinInstance({
      name: "instToStringUInt32",
      params: [],
      resultType: toStringClassOf(nominalType("UInt32", "UInt32")),
      priority: 1000,
    });
  },
};
