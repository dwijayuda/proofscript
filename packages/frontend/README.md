...
Orchestrates parser -> elaborator -> standalone kernel. It is not trusted for theorem validity; generated core is recheckable.


## Production Role

Connects parser, elaborator, environment, and artifact emission for the current product path.

## Trust Boundary

Tier: language  
Lifecycle: canonical  
Trust boundary: Canonical PSC-1 pipeline orchestration; not a kernel replacement.
