...
Portable certificate schema and artifact hashing. Certificates bind evidence; kernel replay still decides logical acceptance.


## Production Role

Defines verification certificate payloads and hashes.

## Trust Boundary

Tier: trusted  
Lifecycle: canonical  
Trust boundary: Certificate format and hashing; standalone by design.
