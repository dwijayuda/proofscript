# Kernel Feature Equivalence Progress — KA-38
...
- Arena corpus regression status: **100% retained from completed gates**
...
| recursor-reduction-iota-eta-k | 30% | WHNF/head-reduction preservation started; recursor/projection/iota open |
| type-inference-checking | 45% | TypeChecker proof-surface bridge; end-to-end executable refinement open |
| defeq-conversion-whnf | 40% | WHNF preservation bridge added; conversion completeness open |
| environment-extension-ordering | 75% | ordinary/quotient/mutual/inductive slices bridged conditionally |
| primitive-axioms-literals | 25% | source present; formal primitive/literal policy bridge open |
...
| metatheory-typing-relations | 55% | multiple imported theory slices bridged; global refinement map open |

## Next highest-impact milestones

- KA39-defeq-whnf-refinement
- KA40-primitive-literal-policy-bridge
