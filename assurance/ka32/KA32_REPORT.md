# KA-32 Feature-Equivalence Audit Report
...
- install/build/test: passed in main worktree.
- KA-32 strict audit: passed.
- Smoke/standalone/PSC gates: passed.
- Arena corpus preflight and static non-performance: passed.
- Arena tutorial wrapper: timed out in this turn and is not counted as a fresh KA-32 pass.
