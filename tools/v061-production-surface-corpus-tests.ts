...
const report = {
  status: failed === 0 ? "production-surface-ready" : "production-surface-gap",
  claim: strict ? "production-surface-corpus-parity" : "audit-only",
  reference: "ProofScript v0.6.1",
  layer: "production parser acceptance/rejection; C3 prerequisite only",
  passed,
  total: all.length,
  positive: {
